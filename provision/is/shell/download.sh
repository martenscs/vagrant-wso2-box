...
then
   ...
   wget --user-agent="testuser" --referer="http://connect.wso2.com/wso2/getform/reg/new_product_download" http://product-dist.wso2.org/products/enterprise-service-bus/4.9.0/wso2esb-4.9.0.zip
fi
...
then
   ...
   wget --user-agent="testuser" --referer="http://connect.wso2.com/wso2/getform/reg/new_product_download" http://product-dist.wso2.com/products/api-manager/1.8.0/wso2am-1.9.1.zip
fi

# BAM
FILE=wso2bam-2.5.0.zip

if [ -f $FILE ];
then
   echo "BAM already downloaded"
else
   wget --user-agent="testuser" --referer="http://connect.wso2.com/wso2/getform/reg/new_product_download" http://product-dist.wso2.com/products/business-activity-monitor/2.5.0/wso2bam-2.5.0.zip
fi
